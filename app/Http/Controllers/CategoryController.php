...
{	
	...
	public function postCreateCategory(Request $request) 
	{
		...
		if ($category->save()) {
			...
			// return redirect()->route('admin.blog.categories')->with(['message' => 'Category Created']);
			// return redirect()->route('admin.blog.categories')->with(response()->json(['message' => 'Category created']));
		}
